...
@section('content')
<form action="{{ route('cp.external-apps.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="link" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link" autofocus="" value="{{ old('link') }}">
